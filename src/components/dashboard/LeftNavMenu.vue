<template>
  <div :class="{closeMenu: isCloseMenu}" class="LeftNavMenu">
    ...
    <el-menu v-if="!isCloseMenu" class="menu" :default-active="activeIndex" @open="handleOpen" @close="handleClose" @select="handleSelect" theme="dark" :style="schema.dashboard.leftNavMenu.style">
      <div v-for="(item,index) in schema.dashboard.leftNavMenu.menus" :key="index">
